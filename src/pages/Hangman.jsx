...
import Hangman1 from '../components/Hangman/images/hangmanSm1.png'
import Hangman2 from '../components/Hangman/images/hangmanSm2.png'
import Hangman3 from '../components/Hangman/images/hangmanSm3.png'
import Hangman4 from '../components/Hangman/images/hangmanSm4.png'
import Hangman5 from '../components/Hangman/images/hangmanSm5.png'
import Hangman6 from '../components/Hangman/images/hangmanSm6.png'
import Hangman7 from '../components/Hangman/images/hangmanSm7.png'
import Hangman8 from '../components/Hangman/images/hangmanSm8.png'
import Hangman9 from '../components/Hangman/images/hangmanSm9.png'
...
export default function Hangman() {
	...
	const winMessage = () => {
		...
		finishText2.innerText = `( total guesses: ${
			...
			<Tablet>
				<Box
					...
					<Box
						...
						sx={{
							width: '90%',
							marginY: { tabletSmall: '1.5rem', tabletLarge: '5rem' },
							borderRadius: '0.5rem',
							padding: '1rem',
							boxShadow: '0 0 0.75rem slategray',
							background: 'lightgray',

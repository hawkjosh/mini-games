...
export default function Square({ value, onClick }) {
	const styleLaptop =
		value === 'X' ? 'square square-laptop x' : 'square square-laptop o'
	const styleTablet =
		value === 'X' ? 'square square-tablet x' : 'square square-tablet o'
	const styleMobile =
		value === 'X' ? 'square square-mobile x' : 'square square-mobile o'
